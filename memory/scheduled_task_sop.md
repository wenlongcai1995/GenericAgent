...
python agentmain.py --reflect reflect/scheduler.py   # 前台运行
python agentmain.py --reflect reflect/scheduler.py --bg  # 后台守护
```

## 触发流程
1. scheduler.py（reflect/）每120秒轮询 sche_tasks/*.json
